...
GHAST_MIN_BURST_COUNT = 1
GHAST_MAX_BURST_COUNT = 4
...
APP_STATE_QUIT = 'quit'
APP_STATE_COUNTDOWN = 'countdown'

COUNTDOWN_SECONDS = 3
COUNTDOWN_FPS = 30
COUNTDOWN_FRAMES = COUNTDOWN_SECONDS * COUNTDOWN_FPS
